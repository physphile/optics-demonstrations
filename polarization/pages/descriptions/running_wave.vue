...
<template>
	<h1>Плоская монохроматическая волна</h1>
	...
	<ul>
		...
		<li>
			Справа вверху &mdash; закон изменения <TexI>\vec E</TexI> и <TexI>\vec H</TexI> от
			времени в выделенной точке пространства (ось <TexI>Oy</TexI> направлена на наблюдателя).
		</li>
		<li>
